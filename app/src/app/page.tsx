  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="relative">
        <div className="relative z-10 flex flex-col xl:flex-row xl:items-start xl:gap-12 xl:max-w-7xl xl:mx-auto xl:px-8">
          <div className="relative max-w-[600px] pl-6 pr-4 py-16 md:pl-16 lg:pl-24 xl:pl-8 xl:py-12 text-left">
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              ...
              <Link
                href="/rent"
                className="rounded-xl border border-white/20 px-5 py-2.5 text-sm font-medium tracking-wide text-slate-200 hover:border-white/40 hover:bg-white/5 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-[#02040A]"
              >
                Start leasing
              </Link>
              <Link
          ...
          <div className="relative z-10 mt-6 xl:mt-12 xl:min-w-[360px] xl:max-w-[400px] pl-6 pr-4 md:pl-16 lg:pl-24 xl:pl-0 xl:pr-8">
            <LiveEvents />
          </div>
        </div>
      </main>
